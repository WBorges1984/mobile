...
begin
    ...
    begin
        while NOT Eof do
        begin
            ind_exclusao := FieldByName('dt_reserva').AsString >
                            FormatDateTime('yyyy-mm-dd', now);

            AddHistoricoListbox(FieldByName('id_reserva').AsInteger,
                                FieldByName('descricao').AsString,
                                FieldByName('nome').AsString,
                                UTCtoShortDateBR(FieldByName('dt_reserva').AsString),
                                FieldByName('hora_reserva').AsString,
                                ind_exclusao);
