...
begin
    ...
    begin
        ...
        begin
            ...
            begin
                foto := TBitmap.Create;
                LoadImageFromURL(foto, frame.imgIcone.TagString);
...
begin
    ...
    begin
        AddServicoListbox(DmGeral.TabServico.FieldByName('id_servico').AsInteger,
                          DmGeral.TabServico.FieldByName('descricao').AsString,
                          DmGeral.TabServico.FieldByName('url_icone').AsString);
